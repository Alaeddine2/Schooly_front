      ...
      this.$refs.loginValidation.validate().then(success => {
        if (success) {
          axiosIns.post('/login', {
            ...
            if(res.status == 200){
              axiosIns.post('/actors/admin/retrieve/login', {
                "id": res.data.user_id
              }).then((adminData) =>{
                ...
                .then(() => {
                  this.$toast({
                    ...
                    position: 'top-right',
                    props: {
                      title: `Welcome ${userData.surname || userData.username}`,
                      icon: 'CoffeeIcon',
                      variant: 'success',
                      text: `You have successfully logged in as ${userData.access_level}. Now you can start to explore!`,
                    },
                  })
                })
              })
              ...
              this.$toast({
                component: ToastificationContent,
                props: {
                  title: 'Invalid username/passwrod',
                  icon: 'CloseIcon',
                  variant: 'error',
                },
              })
